<x-app-layout title="Detail Tagihan">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Detail Tagihan Bulan</h4>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="jam" role="tabpanel">
                                        <div class="card">
                                            <div class="card-header m-3">
                                                <select class="select2" id="pilih_bulan" style="color: white"></select>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="daya">
                                        <div class="tab-pane fade show active" id="daya" role="tabpanel">
                                            <div class="card">
                                                <div class="card-header m-3">
                                                    <select class="select2" id="pilih_bulan_daya"
    ...
    @section('vendor_and_js_datatable')
        ...
        <script type="text/javascript">
            ...
            $('#pilih_bulan').change(() => {
                var id = $('#pilih_bulan').val();
                loadData(id);
            })

            $('#pilih_bulan_daya').change(() => {
                var id = $('#pilih_bulan_daya').val();
                loadData2(id);
            })
                ...
                $("#tabel_tagihan_by_jam").DataTable({
                    ...
                    buttons: [{
                        ...
                        customize: function(win) {
                            ...
                            $(win.document.body).find('h1').text("Detail Tagihan (Jam) Bulan " + id);
                    ...
                    ajax: {
                        url: "{{ route('bulan.get.tagihan.jam') }}",
                        type: "get",
                        data: {
                            id: id,
                        },
                ...
                $("#tabel_tagihan_by_daya").DataTable({
                    ...
                    buttons: [{
                        ...
                        customize: function(win) {
                            ...
                            $(win.document.body).find('h1').text("Detail Tagihan (Daya) Bulan " + id);
                    ...
                    ajax: {
                        url: "{{ route('bulan.get.tagihan.daya') }}",
                        type: "get",
                        data: {
                            id: id,
                        },
