<x-app-layout title="Data by Desa">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Detail by Desa</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <select class="select2" id="pilih_desa" style="color: white"></select>
                        </div>
                        <div class="card-body" id="table_hid">
                            <div class="table-responsive">
                                <table id="tabel_detail_desa" class="display" style="min-width: 845px">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>ID Lampu</th>
    ...
    @section('vendor_and_js_datatable')
        ...
        <script type="text/javascript">
                    ...
                    processResults: function(data) {
                        ...
                        return {
                            ...
                            results: $.map(data, function(item) {
                                return {
                                    text: '' + item.nama_desa + ' (' + item.kodeID + ')',
                                    id: item.id_desa
                                }
                            })
                        };
            ...
            $('#pilih_desa').change(() => {
                var id = $('#pilih_desa').val();
                loadData(id);
            })


            function loadData(id) {
                $("#tabel_detail_desa").DataTable({
                    paging: false,
                    destroy: true,
                    info: false,
                    searching: false,
