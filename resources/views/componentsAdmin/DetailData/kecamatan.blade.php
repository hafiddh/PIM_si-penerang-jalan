<x-app-layout title="Data by Kecamatan">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Detail by Kecamatan</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <select class="select2" id="pilih_camat" style="color: white"></select>
                        </div>
                        <div class="card-body" id="table_hid">
                            <div class="table-responsive">
                                <table id="tabel_detail_camat" class="display" style="min-width: 845px">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>ID Lampu</th>
    ...
    @section('vendor_and_js_datatable')
        ...
        <script type="text/javascript">
            ...
            $('#pilih_camat').select2({
                ...
                language: {
                    inputTooShort: function() {
                        return "Ketik Nama Kecamatan";
                    }
                },
                placeholder: 'Pilih Kecamatan',
                ajax: {
                    url: "{{ route('camat.cari') }}",
                    dataType: 'json',
                    delay: 250,
                    processResults: function(data) {
                        ...
                        return {
                            ...
                            results: $.map(data, function(item) {
                                return {
                                    text: '' + item.nama_kecamatan + ' (' + item.kode + ')',
            ...
            $('#pilih_camat').change(() => {
                var id = $('#pilih_camat').val();
                loadData(id);
            })


            function loadData(id) {
                $("#tabel_detail_camat").DataTable({
                    paging: false,
                    destroy: true,
                    info: false,
                    searching: false,
