            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Update <Datag></Datag>
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('update.light', $light->id_lampu) }}" method="post">
                                @csrf
                                @method('put')
                                <div class="row">

                                    <div class="mb-3 col-md-12">
                                        <label class="form-label">ID Lampu</label>
                                        <input type="text" class="form-control" value="{{ $light->kodeID }}" disabled>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">IDPEL</label>
                                        <select class="default wide form-control wide mb-3 select2" id="idpel"
                                            name="idpel" required>
                                            <option value="{{ $light->id_idpel }}">{{ $light->idpel }}</option>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select class="default wide form-control wide mb-3 select2" id="merk"
                                            name="merk" required>
                                            <option value="{{ $light->id_merk }}">{{ $light->merk }}</option>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="{{ $light->daya }}"
                                            name="daya">
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">Tahun</label>
                                        <select class="select2 default wide form-control wide mb-3" id="tahun"
                                            name="tahun" required>
                                            <option value="" selected disabled>Pilih Tahun</option>
                                            @for ($year = 2010; $year <= 2030; $year++)
                                                <option value="{{ $year }}" {{ $light->tahun == $year ? 'selected' : null }}>{{ $year }}
                                                </option>
                                            @endfor
                                        </select>
                                    </div>
